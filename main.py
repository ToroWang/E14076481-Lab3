...
import os
from settings import WIN_WIDTH, WIN_HEIGHT, FPS, BLACK, PURPLE
...
class Game:
    ...
    def draw(self):
        ...
        for en in self.enemies.get():
            en.draw(self.win)
        # draw wave； 使用f-string 跟 global變數
        wave_str = f'  Wave {wave_num}  '
        font = pygame.font.SysFont('arial', 40)
        text_surface = font.render(wave_str, True, BLACK, (180, 180, 255))
        self.win.blit(text_surface, (15, 15))
